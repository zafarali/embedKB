...
kb.convert_triples()
kb.save_converted_triples('./ntn/triples.npy')
kb.save_mappings_to_json('./ntn/')
...
framework.create_optimizer(optimizer_args={'learning_rate':init_learning_rate})
...
framework.train(dset,
				...
				logging_directory='./ntn/checkpoints')

framework.save_model('./ntn/ntn')
print('True triple score:', framework.score_triple(*true_triple))
print('False triple score:',framework.score_triple(*false_triple))
