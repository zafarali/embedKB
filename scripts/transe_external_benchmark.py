...
from embedKB.models.transe import TransE_External as TransE
...
kb.convert_triples()
kb.save_converted_triples('./transE_external/triples.npy')
kb.save_mappings_to_json('./transE_external')
...
framework.train(dset,
				...
				logging_directory='./transE_external/checkpoints')

framework.save_model('./transE_external/transE_external')
print('True triple score:', framework.score_triple(*true_triple))
print('False triple score:',framework.score_triple(*false_triple))
